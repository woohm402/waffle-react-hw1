...
export const createReviewId = (id?: number): Review["id"] =>
  brand(id ?? Date.now(), "ReviewId");
...
export const createReviewImage = (image?: string): Review["image"] =>
  brand(image, "ReviewImage");
export const createReviewRating = (
